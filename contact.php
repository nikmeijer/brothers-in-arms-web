    ...
    <div class="header-back">
        <header class="full-width-grid-con real-header">
            ...
            <nav class="m-col-start-10 m-col-end-13 l-col-start-10 l-col-end-13 xl-col-start-10 xl-col-end-13">
                ...
                <li><a href="gallery.html" class="see-all-button m-col-start-6 m-col-end-8">Donate Now</a></li>
            </nav>
            <!-- Mobile Menu -->
        ...
        <section class="grid-con">
            <div id="contact-hero" class="col-span-4 m-col-span-12 l-col-span-12 xl-col-span-12">
                ...
                <p class="col-span-4 m-col-span-12 l-col-span-12 xl-col-span-12">Get in touch with us! If you have any
                    ...
                    to
                    reach out. You can contact us via email at info@brothersinarmsmemorial.org or call us at (555)
                    123-4567.
...
<section class="grid-con" id="contact-con">
    ...
    <!-- LEFT: Text Info -->
    <div class="contact-donation-section col-span-4 m-col-span-6 l-col-span-6 xl-col-span-6">
        <h2>Make a donation</h2>
        <p>
            Help us to achieve our goal of having a permanent memorial to those who have fought and served during times of war.
        </p>
        <a href="gallery.html" class="see-all-button">Donate now</a>

        <h2 style="margin-top: 2rem;">Give as you Live</h2>
        <p>
            We are registered with <a href="#">Give as you Live</a>. This means we will receive a small donation if you do your online shopping via Give as you Live. You can sign up to support us via <a href="#">this link</a>.
        </p>
    </div>
    ...
    <div id="contact" class="col-span-4 m-col-span-6 l-col-span-6 xl-col-span-6">
        <form method="post" action="includes/sendmail.php">
            ...
            <input type="text" id="mobile" name="mobile" placeholder="Mobile (Optional)">
    ...
    <div id="site-footer">
        <footer class="grid-con" >
            <div class="col-span-4 m-col-start-1 m-col-end-5 l-col-start-1 l-col-end-5" id="footer-logo">
                ...
                <div class="col-span-2 m-col-start-1 m-col-end-5  footer-container"
                    id="footer-nav-main-container">
                ...
                <div class="col-span-2 m-col-start-6 m-col-end-9 footer-container"
                    id="footer-nav-secondary-container">
