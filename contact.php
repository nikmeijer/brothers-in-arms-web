...
<body>
    ...
    <main>
        ...
        <section class="grid-con" id="contact-con">
            <div class="col-span-4 m-col-span-7 l-col-span-7 xl-col-span-7" id="contact-text">
                ...
                <p>We are registered with <a href="*">Give as you Live.</a> This means we will receive a small donation
                    if
                    you do your online shopping via Give as you Live. You can sign up to support us via <a href="*">this
                        link</a>.</p>
            </div>

            <div id="contact"
                class="col-span-4 m-col-span-5 m-col-start-8 l-col-span-5 l-col-start-8 xl-col-span-5 xl-col-start-8">
